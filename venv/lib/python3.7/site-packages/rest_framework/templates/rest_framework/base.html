...
GET /
    ...
    <span class="badge badge-info">Session Create</span> : <a href="{% url 'session_read' %}">'http://localhost:8000/session/list'</a><br>
...
CREATE /
    ...
    <span class="badge badge-info">Session Read</span>   : <a href="{% url 'session_create' %}">'http://localhost:8000/session/create'</a>
}
