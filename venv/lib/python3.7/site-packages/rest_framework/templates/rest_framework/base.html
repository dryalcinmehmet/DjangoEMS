...
<html>
  ...
  <body class="{% block bodyclass %}{% endblock %}">
    <div class="wrapper">
      {% block navbar %}
        <div class="navbar navbar-static-top {% block bootstrap_navbar_variant %}navbar-inverse{% endblock %}" role="navigation" aria-label="{% trans 'navbar' %}">
          <div class="container">
            <span>
              {% block branding %}
...
GET /
      {
    <span class="badge badge-primary">Event Read</span>     : <a href="{% url 'event_read' %}">'http://localhost:8000/event/list'</a><br>
    <span class="badge badge-info">Session Read</span> : <a href="{% url 'session_read' %}">'http://localhost:8000/session/list'</a><br>
...
CREATE /
    ...
    <span class="badge badge-danger">Event Create</span>   : <a href="{% url 'event_create' %}">'http://localhost:8000/event/create'</a><br>
    <span class="badge badge-info">Session Create</span>   : <a href="{% url 'session_create' %}">'http://localhost:8000/session/create'</a>
}

PUT && DELETE /
      {
    <span class="badge badge-primary">Event Update</span>   : <a href="#">format : {'http://localhost:8000/event/event_id'}</a><br>
    <span class="badge badge-danger">Session Update</span>  : <a href="#">format: {'ttp://localhost:8000/session/session_id'}</a><br>
  ...
  {%else%}
          ...
          <button class="btn btn-primary js-tooltip" onclick="myFunction()">< Go To Root Page</button>
            <script>
            function myFunction() {
